...
databaseDriverTests = function() {
	...
	switch(config.type) {
	case 'couch':
		var DB = require('../databaseMiddleware/couchDB/stuffInACouch.js')
		break;
	case 'redis':
		var DB = require('../databaseMiddleware/redis/redisToBurn.js')
		break;
	case 'mongo':
		var DB = require('../databaseMiddleware/mongoDB/iAmAGoldenMongod.js')
		break;
	case 'riak':
		var DB = require('../databaseMiddleware/riak/riakTheSlit.js')
		break;
	}
...
//create database
module.exports = databaseDriverTests;